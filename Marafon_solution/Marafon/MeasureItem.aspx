<%@ Page Title="Единицы измерения" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeasureItem.aspx.cs" Inherits="Marafon.MeasureItem" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.MEASURE_ITEM WHERE (MEASURE_ITEM_ID = @MEASURE_ITEM_ID)"
                InsertCommand="INSERT INTO MEASURE_ITEM (SUSER) VALUES(@SUSER)" 
                SelectCommand="SELECT MEASURE_ITEM_ID, MEASURE_ITEM_CODE, DESCRIPTION, SUSER FROM MEASURE_ITEM"
                UpdateCommand="UPDATE MEASURE_ITEM SET MEASURE_ITEM_CODE=@MEASURE_ITEM_CODE, DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE MEASURE_ITEM_ID=@MEASURE_ITEM_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="MEASURE_ITEM_ID" />
                </DeleteParameters>
                <UpdateParameters>
                    <asp:Parameter Name="MEASURE_ITEM_CODE" />
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="MEASURE_ITEM_ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Код" SortExpression="MEASURE_ITEM_CODE">
                        <ItemTemplate>
                            <asp:Label ID="lblMeasure_Item_Code" runat="server" Text='<%# Bind("MEASURE_ITEM_CODE") %>' Width="50px"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="tboxMeasure_Item_Code" runat="server" Text='<%# Bind("MEASURE_ITEM_CODE") %>' Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvMeasure_Item_Code" runat="server" ControlToValidate="tboxMeasure_Item_Code"
                    ...
                    <asp:TemplateField HeaderText="Название" SortExpression="DESCRIPTION">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="tboxDescription" runat="server" Text='<%# Bind("DESCRIPTION") %>' Width="200px"></asp:TextBox>
