...
namespace Marafon
{
    public partial class ABGroup : System.Web.UI.Page
    {
        private string strIDName = "AB_GROUP_id";
        private string strTableName = "AB_GROUP";
        ...
        protected void btnAddDictionary_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                this.tboxFindDictionary.Text = "";
                int intID = MarafonHelper.AddRecord(this.gvwDictionary, "MarafonConnection", strTableName, "DESCRIPTION,GROUP_CODE,SUSER", String.Format("'-','00000','{0}'", Session["uid"]), strIDName);
                if (intID > 0)
                {
