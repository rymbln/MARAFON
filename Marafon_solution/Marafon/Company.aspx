<%@ Page Title="Компании" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="Marafon.Company" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.Company WHERE (Company_ID = @Company_ID)"
                InsertCommand="INSERT INTO Company (SUSER) VALUES(@SUSER)" SelectCommand="SELECT Company_ID, DESCRIPTION, SUSER FROM Company"
                UpdateCommand="UPDATE Company SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE Company_ID=@Company_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="Company_ID"
