...
namespace Marafon
{
    public partial class PatientGroup : System.Web.UI.Page
    {
        private string strIDName = "Patient_Group_id";
        private string strTableName = "Patient_Group";
        ...
        //protected void btnFindDictionary_Click(object sender, System.EventArgs e)
        //{
        //    try
        //    {
        //if (MarafonHelper.CheckEditMode(this.gvwDictionary, lblFindError, this.dsrcDictionary, fnFilterDictionary()))
        //{
        //    if (Session["tboxFindDictionary"] != null)
        //    {
        //        this.tboxFindDictionary.Text = Session["tboxFindDictionary"].ToString();
        //    }
        //    else
        //    {
        //        this.tboxFindDictionary.Text = "";
        ...
        //else
        //{
        //    Session["tboxFindDictionary"] = this.tboxFindDictionary.Text;
        //}
        //    }
        //    catch (Exception ex)
        //    {
