<%@ Page Title="Типы отделений" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WardType.aspx.cs" Inherits="Marafon.WardType" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.WARD_TYPE WHERE (WARD_TYPE_ID = @WARD_TYPE_ID)"
                InsertCommand="INSERT INTO WARD_TYPE (SUSER) VALUES(@SUSER)" SelectCommand="SELECT WARD_TYPE_ID, DESCRIPTION, SUSER FROM WARD_TYPE"
                UpdateCommand="UPDATE WARD_TYPE SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE WARD_TYPE_ID=@WARD_TYPE_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="WARD_TYPE_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="WARD_TYPE_ID"
