...
namespace Marafon
{
    ...
    {
        private string strIDName = "Region_id";
        private string strTableName = "Region";
        ...
        protected void btnAddDictionary_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                this.tboxFindDictionary.Text = "";
                int intID = MarafonHelper.AddRecord(this.gvwDictionary, "MarafonConnection", strTableName, "REGION_CODE,DESCRIPTION,SUSER", String.Format("0,'-','{0}'", Session["uid"]), strIDName);
                if (intID > 0)
                {
