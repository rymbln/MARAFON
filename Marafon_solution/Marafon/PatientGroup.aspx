<%@ Page Title="Группы пациентов" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PatientGroup.aspx.cs" Inherits="Marafon.PatientGroup" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.Patient_Group WHERE (Patient_Group_ID = @Patient_Group_ID)"
                InsertCommand="INSERT INTO Patient_Group (SUSER) VALUES(@SUSER)" SelectCommand="SELECT Patient_Group_ID, DESCRIPTION, SUSER FROM Patient_Group"
                UpdateCommand="UPDATE Patient_Group SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE Patient_Group_ID=@Patient_Group_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="Patient_Group_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="Patient_Group_ID"
