<%@ Page Title="Группы АБ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ABGroup.aspx.cs" Inherits="Marafon.ABGroup" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.AB_GROUP WHERE (AB_GROUP_ID = @AB_GROUP_ID)"
                InsertCommand="INSERT INTO AB_GROUP (SUSER) VALUES(@SUSER)" SelectCommand="SELECT AB_GROUP_ID, DESCRIPTION, GROUP_CODE, SUSER FROM AB_GROUP"
                UpdateCommand="UPDATE AB_GROUP SET DESCRIPTION = @DESCRIPTION, GROUP_CODE=@GROUP_CODE, SUSER = @SUSER WHERE AB_GROUP_ID=@AB_GROUP_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="AB_GROUP_ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Название" SortExpression="DESCRIPTION">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="tboxDescription" runat="server" Text='<%# Bind("DESCRIPTION") %>' Width="400px"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Код ATC" SortExpression="GROUP_CODE">
                        <ItemTemplate>
                            <asp:Label ID="lblGroup_Code" runat="server" Text='<%# Bind("GROUP_CODE") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="tboxGroup_Code" runat="server" Text='<%# Bind("GROUP_CODE") %>' Width="100px"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
