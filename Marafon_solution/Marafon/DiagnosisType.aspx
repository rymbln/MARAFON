<%@ Page Title="Типы диагнозов" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DiagnosisType.aspx.cs" Inherits="Marafon.DiagnosisType" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.DIAGNOSIS_TYPE WHERE (DIAGNOSIS_TYPE_ID = @DIAGNOSIS_TYPE_ID)"
                InsertCommand="INSERT INTO DIAGNOSIS_TYPE (SUSER) VALUES(@SUSER)" SelectCommand="SELECT DIAGNOSIS_TYPE_ID, DESCRIPTION, SUSER FROM DIAGNOSIS_TYPE"
                UpdateCommand="UPDATE DIAGNOSIS_TYPE SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE DIAGNOSIS_TYPE_ID=@DIAGNOSIS_TYPE_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="DIAGNOSIS_TYPE_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="DIAGNOSIS_TYPE_ID"
