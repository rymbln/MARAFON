<%@ Page Title="Пути введения" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminRoute.aspx.cs" Inherits="Marafon.AdminRoute" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.Admin_Route WHERE (Admin_Route_ID = @Admin_Route_ID)"
                InsertCommand="INSERT INTO Admin_Route (SUSER) VALUES(@SUSER)" SelectCommand="SELECT Admin_Route_ID, DESCRIPTION, SUSER FROM Admin_Route"
                UpdateCommand="UPDATE Admin_Route SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE Admin_Route_ID=@Admin_Route_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="Admin_Route_ID"
