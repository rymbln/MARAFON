<%@ Page Title="Пол" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sex.aspx.cs" Inherits="Marafon.Sex" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.SEX WHERE (SEX_ID = @SEX_ID)"
                InsertCommand="INSERT INTO SEX (SUSER) VALUES(@SUSER)" SelectCommand="SELECT SEX_ID, DESCRIPTION, SUSER FROM SEX"
                UpdateCommand="UPDATE SEX SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE SEX_ID=@SEX_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="SEX_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="SEX_ID"
