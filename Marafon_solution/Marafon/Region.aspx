<%@ Page Title="Регионы" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Region.aspx.cs" Inherits="Marafon.Region" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.REGION WHERE (REGION_ID = @REGION_ID)"
                InsertCommand="INSERT INTO REGION (REGION_CODE, DESCRIPTION, SUSER) VALUES(0,'-', @SUSER)"
                SelectCommand="SELECT REGION_ID, REGION_CODE, DESCRIPTION, SUSER FROM REGION"
                UpdateCommand="UPDATE REGION SET REGION_CODE = @REGION_CODE, DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE REGION_ID=@REGION_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="REGION_ID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Код региона" SortExpression="REGION_CODE">
                        <ItemTemplate>
                            <asp:Label ID="lblRegion_Code" runat="server" Text='<%# Bind("REGION_CODE") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="tboxRegion_Code" runat="server" Text='<%# Bind("REGION_CODE") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvRegion_Code" runat="server" ControlToValidate="tboxRegion_Code"
