<%@ Page Title="Кратность введения" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Frequency.aspx.cs"
    Inherits="Marafon.Frequency" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.FREQUENCY WHERE (FREQUENCY_ID = @FREQUENCY_ID)"
                InsertCommand="INSERT INTO FREQUENCY (SUSER) VALUES(@SUSER)" SelectCommand="SELECT FREQUENCY_ID, DESCRIPTION, SUSER FROM FREQUENCY"
                UpdateCommand="UPDATE FREQUENCY SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE FREQUENCY_ID=@FREQUENCY_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="FREQUENCY_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="FREQUENCY_ID"
