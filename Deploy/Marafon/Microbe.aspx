<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Microbe.aspx.cs" Inherits="Marafon.Microbe" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.Microbe WHERE (Microbe_ID = @Microbe_ID)"
                InsertCommand="INSERT INTO Microbe (SUSER) VALUES(@SUSER)" SelectCommand="SELECT Microbe_ID, DESCRIPTION, SUSER FROM Microbe"
                UpdateCommand="UPDATE Microbe SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE Microbe_ID=@Microbe_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="Microbe_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="Microbe_ID"
