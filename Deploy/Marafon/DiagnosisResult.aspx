<%@ Page Title="Исходы развития диагнозов" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DiagnosisResult.aspx.cs" Inherits="Marafon.DiagnosisResult" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.DIAGNOSIS_RESULT WHERE (DIAGNOSIS_RESULT_ID = @DIAGNOSIS_RESULT_ID)"
                InsertCommand="INSERT INTO DIAGNOSIS_RESULT (SUSER) VALUES(@SUSER)" SelectCommand="SELECT DIAGNOSIS_RESULT_ID, DESCRIPTION, SUSER FROM DIAGNOSIS_RESULT"
                UpdateCommand="UPDATE DIAGNOSIS_RESULT SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE DIAGNOSIS_RESULT_ID=@DIAGNOSIS_RESULT_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="DIAGNOSIS_RESULT_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="DIAGNOSIS_RESULT_ID"
