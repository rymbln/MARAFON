<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Diagnosis.aspx.cs" Inherits="Marafon.Diagnosis" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.Diagnosis WHERE (Diagnosis_ID = @Diagnosis_ID)"
                InsertCommand="INSERT INTO Diagnosis (SUSER) VALUES(@SUSER)" SelectCommand="SELECT Diagnosis_ID, DESCRIPTION, SUSER FROM Diagnosis"
                UpdateCommand="UPDATE Diagnosis SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE Diagnosis_ID=@Diagnosis_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="Diagnosis_ID"
