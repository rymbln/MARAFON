<%@ Page Title="Логические значения" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Logic.aspx.cs" Inherits="Marafon.Logic" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.LOGIC WHERE (LOGIC_ID = @LOGIC_ID)"
                InsertCommand="INSERT INTO LOGIC (SUSER) VALUES(@SUSER)" SelectCommand="SELECT LOGIC_ID, DESCRIPTION, SUSER FROM LOGIC"
                UpdateCommand="UPDATE LOGIC SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE LOGIC_ID=@LOGIC_ID"
                ProviderName="System.Data.SqlClient">
                <DeleteParameters>
                    <asp:Parameter Name="LOGIC_ID" />
                </DeleteParameters>
                <UpdateParameters>
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="LOGIC_ID"
