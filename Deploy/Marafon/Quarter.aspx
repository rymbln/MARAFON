<%@ Page Title="Кварталы" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Quarter.aspx.cs" Inherits="Marafon.Quarter" Theme="Marafon" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="dsrcDictionary" runat="server" ConnectionString="<%$ ConnectionStrings:MarafonConnection %>"
                DeleteCommand="DELETE FROM dbo.QUARTER WHERE (QUARTER_ID = @QUARTER_ID)"
                InsertCommand="INSERT INTO QUARTER (SUSER) VALUES(@SUSER)" SelectCommand="SELECT QUARTER_ID, DESCRIPTION, SUSER FROM QUARTER"
                UpdateCommand="UPDATE QUARTER SET DESCRIPTION = @DESCRIPTION, SUSER = @SUSER WHERE QUARTER_ID=@QUARTER_ID"
            ...
            <asp:GridView ID="gvwDictionary" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CellPadding="4" CssClass="controls" DataKeyNames="QUARTER_ID"
